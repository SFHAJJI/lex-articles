---
lex_id: 'eu-eurlex:32010l0078:2011-01-04--7f718c602e2831e75f2c8c6d27b9c5a9076f39be0cbbfbfc315d4a03751d7482'
title: 'Directive 2010/78/EU'
valid_from: '2011-01-04'
valid_to: '2019-01-12'
source: 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02010L0078-20110104'
source_sha256: '14efe22998ff542bcb38f0f25e934272eb1d2da27556ba76e92673a841dcaa21'
...
(6) In Article 16(2), the following subparagraph is added:
...
(12) In Article 32, the following paragraph is added:
...
(13) In Article 36, the following paragraph is added:
...
(15) In Article 42(6), the second subparagraph is replaced by the following:
...
(17) Article 48 is amended as follows:
...
(18) In Article 51, the following paragraphs are added:
...
(20) The Title of Chapter II is replaced by the following:

‘Cooperation between the competent authorities of the Member States and with ESMA’.

(21) Article 56 is amended as follows:
...
(23) Article 58 is amended as follows:
...
(b) to exchange information as provided for in Article 58.
...
(25) Article 59, the second paragraph is replaced by the following:
...
(26) In Article 60, the following paragraph is added:
...
(29) Article 63(1) is replaced by the following:
...
(30) The following Article is inserted
...
(1) Article 2(3) is amended as follows:
...
(2) Article 5(6) is amended as follows:
...
(3) Article 9(7) is amended as follows:
...
(16) The title of Chapter VI is replaced by the following:
...
(7) The title of Chapter VI is replaced by the following:
...
(2) In Article 9(2), point b is replaced by the following:
...
(4) Article 17(2) is replaced by the following:
...
(5) In Article 19, the following paragraph is added:
...
(6) In Article 22, the following paragraph is added:
...
(9) In Article 28, the following paragraph is added:
...
(11) Article 36 is replaced by the following:
...
(12) Article 38(2) is replaced by the following:
...
(13) In Article 39 is amended as follows:
...
(14) In Article 42, the following paragraphs are added:
...
(15) Article 42a is amended as follows:

(a) in paragraph 1, the following subparagraph is inserted after the fourth subparagraph:
...
(16) Article 42b is amended as follows:
...
(19) Article 49 is amended as follows:
...
(20) Article 63a is amended as follows:
...
(22) In Article 81(2) the following subparagraphs are added:
...
(23) In Article 84(2), the following subparagraphs are added:
...
(24) In Article 97(2), the following subparagraphs are added:
...
(25) In Article 105(1), the following subparagraphs are added:
...
(28) In Article 111(1), the fourth subparagraph is replaced by the following:

‘Member States may set a lower limit than EUR 150 million and shall inform EBA and the Commission thereof.’.

(29) Article 122a(10) is replaced by the following:
...
(30) In Article 124, the following paragraph is added:
...
(b) in paragraph 2, the following is added to the fifth subparagraph:
...
(c) in paragraph 2, the following subparagraphs are added:
...
(iv) the seventh subparagraph is replaced by the following:
...
(35) Article 131a is amended as follows:
...
(36) Article 132(1) is amended as follows:

(a) the following subparagraphs are inserted after the first subparagraph:
...
(38) Article 143 is amended as follows:

(a) paragraph (2) is amended as follows:

(i) the following sentence is added at the end of the first subparagraph:
...
(39) In Article 144, the following paragraphs are added:
...
(40) In Article 150, the following paragraph is added:
...
(41) Article 156 is amended as follows:
...
(1) In Article 18, the following paragraph is added:
...
(2) In Article 22(1), the following subparagraph is added:
...
(3) Article 32(1) is amended as follows:
...
(4) Article 36(1) is replaced by the following:
...
(5) In Article 38(1), the following subparagraphs are added:
...
(8) In Article 17, the following paragraph is added:
...
(9) In Article 18, the following paragraph is added:
...
(10) In Article 20, the following paragraph is added:
...
(b) in paragraph 7, the first and second subparagraphs are replaced by the following:
...
(12) Article 23(6) is amended as follows:
...
(13) In Article 29, the following paragraphs are added:
...
(14) Article 32(6) is replaced by the following:
...
(15) Article 33(6) is amended as follows:
...
(17) In Article 50, the following paragraph is added:
...
(18) Article 51 is amended as follows:
...
(21) Article 61 is amended as follows:
...
(22) Article 62(4) is replaced by the following:
...
(23) Article 64 is amended as follows:
...
(24) In Article 69, the following paragraph is added:
...
(26) Article 78 is amended as follows:
...
(28) In Article 83, the following paragraph is added:
...
(29) In Article 84, the following paragraph is added:
...
(30) Article 95 is replaced by the following:
...
(31) Article 97(1) is replaced by the following:
...
(32) Article 101 is amended as follows:
...
(33) Article 102 is amended as follows:
...
(34) Article 103 is amended as follows:
...
(36) Article 108(5) is amended as follows:
...
(37) The title of chapter XIII is replaced by the following:
...
(1) Opinion of 18 March 2010 (OJ C 87, 1.4.2010, p. 1).

(2) Opinion of 18 March 2010 (not yet published in the Official Journal).
...
(5) See page 48 of this Official Journal.

(6) See page 84 of this Official Journal.
...
(12) OJ L 177, 30.6.2006, p. 201.

(13) OJ L 166, 11.6.1998, p. 45.

(14) OJ L 35, 11.2.2003, p. 1.
...
(23) OJ L 331, 15.12.2010, p. 1.’.

(24) OJ L 331, 15.12.2010, p. 84.’.
...
(30) OJ L 331, 15.12.2010, p. 84.’.

(31) OJ L 331, 15.12.2010, p. 1.’;

(32) OJ L 331, 15.12.2010, p. 12.

(33) OJ L 331, 15.12.2010, p. 48.

(34) OJ L 331, 15.12.2010, p. 84.’.

(35) OJ L 331, 15.12.2010, p. 12.’;

(36) OJ L 331, 15.12.2010, p. 1.’;

(37) OJ L 331, 15.12.2010, p. 84.’.

(38) OJ L 331, 15.12.2010, p. 12.’.

(39) OJ L 331, 15.12.2010, p. 84.’.

(40) OJ L 331, 15.12.2010, p. 1.’;

(41) OJ L 331, 15.12.2010, p. 12.

(42) OJ L 331, 15.12.2010, p. 48.’.
