---
lex_id: 'eu-eurlex:32010r0920:2011-11-30'
...
valid_to: '2013-05-03'
source: 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02010R0920-20111130'
source_sha256: 'd08a21c0249c96a72ff89e3cbb8b4db34d8accecb78584e5f2881c7ffeda0793'
...
### Article 4 — European Union Transaction Log
...
### Article 5 — Communication links between registries, the ITL and the EUTL
...
### Article 6 — National administrators and KP registry administrators
...
### Article 11 — Notifications from the administrators
...
### Article 12 — Opening of KP Party accounts and management accounts
...
### Article 13 — Opening of person holding accounts in the Union registry
...
### Article 13a — Opening of trading accounts in the Union Registry
...
### Article 14 — Opening of trading platform holding accounts in the Union registry
...
### Article 15 — Opening of operator holding accounts in the Union registry
...
### Article 16 — Opening of aircraft operator holding accounts in the Union registry
...
### Article 17 — Opening of verifier accounts in the Union registry
...
### Article 18 — Refusal to open an account
...
### Article 20 — Nominating and approval of authorised representatives and additional authorised representatives
...
### Article 21 — Updating of account information and information on authorised representatives
...
### Article 21a — Trusted account list
...
### Article 22 — Closure of KP Party accounts, management accounts, person holding accounts and trading platform holding accounts
...
### Article 23 — Closure of operator holding accounts
...
### Article 24 — Closure of aircraft operator holding accounts
...
### Article 25 — Closure of verifier accounts
...
### Article 26 — Positive balance on accounts under closure
...
### Article 27 — Suspension of access to accounts
...
### Article 28 — Closure of accounts and removal of authorised representative on the administrator's initiative
...
### Article 32 — Inactive aircraft operator holding accounts
...
### Article 59 — Availability and reliability of the Union registry and the EUTL
...
### Article 61 — Authentication of registries and the EUTL
...
### Article 62 — Accessing accounts in the Union registry
...
### Article 63 — Authentication and authorisation of authorised representatives in the Union registry
...
### Article 64 — Suspension of all access due to a security breach or a security risk
...
### Article 64a — Suspension of access to allowances or Kyoto units in case of a suspected fraudulent transaction
...
### Article 65 — Suspension of processes
...
### Article 66 — Automated checking of processes
...
### Article 67 — Detection of discrepancies
...
### Article 68 — Detection of discrepancies by the registries
...
### Article 69 — Reconciliation — Detection of inconsistencies by the EUTL
...
### Article 70 — Finalisation of processes
...
### Article 71 — Data exchange and technical specifications
...
### Article 77 — Migration and Decoupling
...
(i) create an amount of allowances not recognised as AAUs by the ITL in the Union registry that is equal to the amount transferred in accordance with paragraph (1)(a);

(ii) make available in the Union registry a set of accounts equivalent to the set from which allowances were transferred in accordance with paragraph (1)(a);

(iii) transfer an amount of allowances created in accordance with (i) to accounts referred to in (ii). The amount of allowances transferred to each such account shall be equal to the amount transferred from the equivalent account in accordance with paragraph (1)(a).
...
### Article 78 — Amendments of Regulation (EC) No 2216/2004
...
2. in Article 10, paragraph 2 is replaced with the following paragraphs 2 to 2e:
...
3. in Article 11, the following paragraph 6 is added:
...
4. in Article 19, paragraph 2 is replaced with the following:
...
5. in Article 19, paragraph 3 is replaced with the following:
...
6. in Article 19, the following paragraphs 5 and 6 are added:
...
7. the following Article 21a is inserted:
...
8. in Article 23, the following paragraphs 5 to 10 are added:
...
9. in Article 34a, the following paragraph 2a is inserted:
...
10. Section 1 of Chapter V is deleted;

11. Article 49(1)(b) is deleted;

12. Article 53 is amended as follows:
...
13. Article 54 is deleted;

14. Article 58 is deleted;

15. Section 7 of Chapter V is deleted;

16. Article 62(2) is deleted;

17. in Article 67, the following paragraphs 1a, 1b and 1c are inserted:
...
18. Annex IV is replaced with the following:
...
19. the following Annex IVa is inserted:
...
20. Annex XIa is amended as follows:

(a) in Table XIa-3, the sentence ‘The allowances allocated for the years before the current year will have a value of zero.’ is deleted;

(b) in Table XIa-4, the sentence ‘The allowances allocated for the years before the current year won’t be modified.’ is deleted;

(c) in Table XIa-7, the code ‘7215’ is deleted;

21. in Annex XII, the description beside response code 7701 in Table XII-I shall be replaced with the following text:

‘Allocation must be provided for all the years.’;

22. Annex XVI is amended as follows:

1. point 1 is replaced with the following:
...
2. point 2(a) is replaced with the following:
...
(b) units surrendered pursuant to Articles 52 and 53, by unit identification code (in the case of ERUs and CERs), for year X shall be displayed from 1 May onwards of year (X+1);’;
...
6. point 12a is replaced by the following:
