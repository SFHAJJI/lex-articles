---
lex_id: 'eu-eurlex:32010r0920:2013-05-04--7af109391094d0023fa5e29ccc31b70be66c8cd8afed81b694f011c35616dc67'
...
valid_to: '2013-09-30'
source: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:02010R0920-20130504'
source_sha256: '60e05a4d16cdbfb481e045c65ecc97f6a58d3995e801c31d3744db7b5ab66242'
...
<a id="art_premier_bis"></a>

### Article premier bis — Champ d’application
...
26) «heure d’Europe centrale», l’heure d’été d’Europe centrale pendant la période d’été définie aux articles 1er, 2 et 3 de la directive 2000/84/CE du Parlement européen et du Conseil (14).
...
### Article 29 — Émissions vérifiées d'une installation ou d'un exploitant d'aéronef
...
### Article 30 — Blocage de comptes pour défaut de communication des émissions vérifiées
...
### Article 31 — Calcul des soldes indicatifs de l'état de conformité
...
### Article 32 — Comptes de dépôt d’exploitant d’aéronef exclus
...
### Article 32 bis — Exécution des transferts
...
### Article 32 ter — Nature des quotas et irrévocabilité des transactions
...
### Article 33 — Tableaux «Plan national d'allocation de quotas»
...
### Article 34 — Tableau «Allocation de quotas “aviation” à l'échelle de l'Union»
...
d) l’identité des bénéficiaires de l’allocation [dans le cas des quotas alloués par enchères, le bénéficiaire est le compte créé à cet effet par le règlement (UE) no 1193/2011 de la Commission (15)].

2. Le tableau «Allocation de quotas “aviation” à l'échelle de l'Union» respecte le format décrit à l'annexe XII.

<a id="art_35"></a>

### Article 35 — Saisie des tableaux «Plan national d'allocation de quotas» dans l'EUTL
...
### Article 36 — Introduction des décisions d'allocation dans le tableau «Allocation de quotas “aviation” à l'échelle de l'Union»
...
### Article 37 — Correction des tableaux «Plan national d'allocation de quotas»
...
### Article 38 — Correction du tableau «Allocation de quotas “aviation” à l'échelle de l'Union»
...
### Article 39 — Délivrance de quotas du chapitre III
...
### Article 40 — Allocation de quotas du chapitre III
...
### Article 41 — Allocation de quotas du chapitre II
...
### Article 42 — Allocation de quotas du chapitre III consécutivement à leur vente par un État membre
...
### ***Transferts de quotas et d'unités de Kyoto***

<a id="art_43"></a>

### Article 43 — Transferts de quotas par des titulaires de comptes
...
2. À compter du 30 juin 2012, les comptes de dépôt d’exploitant, les comptes de dépôt d’exploitant d’aéronef, les comptes de dépôt de personne et les plates-formes de négociation peuvent uniquement transférer des quotas sur un compte qui figure sur la liste des comptes de confiance établie conformément à l’article 21 *bis*.

<a id="art_44"></a>

### Article 44 — Transferts d’unités de Kyoto par des titulaires de comptes
...
### Article 45 — Avoir minimal en quotas du chapitre III des comptes de dépôt du registre de l'Union gérés par un même État membre
...
### Article 46 — Restitution de quotas
...
### Article 48 — Restitution d’URCE et d’URE
...
### Article 49 — Suppression de quotas
...
### Article 50 — Annulation d’unités de Kyoto
...
### Article 51 — Annulation de processus finalisés engagés par erreur
...
### Article 52 — Provision minimale du compte de provision d'UQA du SCEQE
...
### Article 53 — Quantité de transit et compte de provision de transit
...
### Article 54 — Mise en réserve d'UQA en contrepartie de la restitution de quotas du chapitre III par des exploitants d'aéronef
...
### Article 55 — Annulation d'unités de Kyoto en contrepartie de la suppression de quotas du chapitre III
...
### Article 56 — Compensation des transferts de quotas
...
### Article 57 — Report d’une période à une autre
...
### Article 58 — Retrait d'UQA, d'URE et d'URCE pour couvrir les émissions dues aux activités aériennes domestiques des exploitants d'aéronef
...
**Tableau I-I:** **Types de comptes et types d'unités pouvant être détenus sur chacun**
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Quotas du chapitre III | Quotas du chapitre II | UQA | URCE | URE | URCED/ URCET/UAB |  |  |  |  |
| I. *Comptes de partie au PK des registres PK (y compris le registre de l'Union)* |  |  |  |  |  |  |  |  |  |
...
| II. *Comptes de gestion du registre de l'Union* |  |  |  |  |  |  |  |  |  |
...
| III. *Comptes d'utilisateur du registre de l'Union* |  |  |  |  |  |  |  |  |  |
| Compte de dépôt d'exploitant | Exploitant | Administrateur national de l'EM dans lequel est située l'installation | Un pour chaque installation/exploitant d'aéronef/ personne/plate-forme de négociation dans l'EM | Oui | Non | EM (1) | Oui | Oui | EM (1) |
| Compte de dépôt d'exploitant d'aéronef | Exploitant d’aéronef | Administrateur national de l'EM responsable de l'exploitant d'aéronef | Oui | Oui | EM (1) | Oui | Oui | EM (1) |  |
| Compte de dépôt de personne | Personne | Administrateur national qui a ouvert le compte | Oui | Oui | EM (1) | Oui | Oui | EM (1) |  |
| Compte de dépôt de plate-forme de négociation | Plate-forme de négociation | Oui | Oui | EM (1) | Oui | Oui | EM (1) |  |  |
| Compte de vérificateur | Vérificateur | Un par vérificateur | Non | Non | Non | Non | Non | Non |  |
| (1)Il appartient à l'administrateur national de l'EM de décider si le compte (ou le type de compte) peut contenir ce type d'unités. |  |  |  |  |  |  |  |  |  |

<a id="annexe_ii"></a>

### ANNEXE II

**Types de transactions possibles à partir et à destination de chaque type de comptes (et type d'unités concernées)**
...
| I. *Comptes de partie au PK du registre de l'Union et de tous les autres registres PK* |  |  |  |  |  |  |  |  |  |  |  |  |
...
**Informations devant accompagner les demandes d'ouverture de comptes de partie au PK et de comptes de gestion**
...
|  | A | B | C | D | E | F |
| --- | --- | --- | --- | --- | --- | --- |
| No | Donnée détaillée du compte | Obligatoire/ Facultatif | Type | Mise à jour possible? | Agrément de l'AN nécessaire pour la mise à jour? | Publication sur le site web public du RU? |
...
| 12 | Adresse TC — no de rue | O | Libre | Oui | Oui | Oui |
| 13 | No d'enregistrement ou no d'identification de l'entreprise du TC | O | Libre | Oui | Oui | Oui |
...
**Informations à fournir à l’administrateur national concernant les comptes de dépôt de personne et les comptes de dépôt de plate-forme de négociation**
...
**Informations supplémentaires à fournir à l'administrateur national concernant les comptes de dépôt de plate-forme de négociation**
...
2. Dans les données fournies conformément au tableau III-I, le titulaire de compte indiqué est l'exploitant de l'installation. Le nom indiqué pour le titulaire du compte doit être identique au nom de la personne physique ou morale qui est titulaire de l'autorisation d'émettre des émissions de gaz à effet de serre correspondante.
...
| 12 | Adresse de l'installation — no de rue | O | Libre | Oui | Oui | Oui |
...
|  | Raison sociale | F | Libre | Oui | Non | Oui (1) |
|  | Service | F | Libre | Oui | Non | Oui (1) |
| 2 | Prénom de la personne de contact dans l'EM | F | Libre | Oui | Non | Oui (1) |
| 3 | Nom de la personne de contact dans l'EM | F | Libre | Oui | Non | Oui (1) |
| 4 | Adresse de la personne de contact – pays | F | Prédéfini | Oui | Non | Oui (1) |
| 5 | Adresse de la personne de contact – région ou État | F | Libre | Oui | Non | Oui (1) |
| 6 | Adresse de la personne de contact – localité | F | Libre | Oui | Non | Oui (1) |
| 7 | Adresse de la personne de contact – code postal | F | Libre | Oui | Non | Oui (1) |
| 8 | Adresse de la personne de contact – rue | F | Libre | Oui | Non | Oui (1) |
| 9 | Adresse de la personne de contact – no de la rue | F | Libre | Oui | Non | Oui (1) |
| 10 | Téléphone 1 de la personne de contact | F | Libre | Oui | Non | Oui (1) |
| 11 | Téléphone 2 de la personne de contact | F | Libre | Oui | Non | Oui (1) |
| 12 | Adresse électronique de la personne de contact | F | Libre | Oui | Non | Oui (1) |
| (1)Ces données ne sont pas publiées si le titulaire de compte demande qu'elles restent confidentielles conformément à l'article 75. |  |  |  |  |  |  |
...
**Informations à fournir à l'administrateur de registre concernant chaque compte de dépôt d'exploitant d'aéronef**
...
**Informations à fournir à l’administrateur du compte concernant les représentants autorisés et les représentants autorisés supplémentaires**
...
| 3 | Prénom | O | Libre | Oui | Oui | Non (1) |
| 4 | Nom | O | Libre | Oui | Oui | Non (1) |
| 5 | Titre | F | Libre | Oui | Non | Non (1) |
| 6 | Désignation de la fonction | F | Libre | Oui | Non | Non (1) |
|  | Raison sociale | F | Libre | Oui | Non | Non (1) |
|  | Service | F | Libre | Oui | Non | Non (1) |
| 7 | Pays | O | Prédéfini | Non | s.o. | Non (1) |
| 8 | Région ou état | F | Libre | Oui | Oui | Non (1) |
| 9 | Ville | O | Libre | Oui | Oui | Non (1) |
| 10 | Code postal | O | Libre | Oui | Oui | Non (1) |
| 11 | Adresse — ligne 1 | O | Libre | Oui | Oui | Non (1) |
| 12 | Adresse — ligne 2 | F | Libre | Oui | Oui | Non (1) |
| 13 | Téléphone 1 | O | Libre | Oui | Non | Non (1) |
| 14 | Téléphone portable | O | Libre | Oui | Oui | Non (1) |
...
| (1)Ces données ne sont publiées que si le titulaire de compte demande qu’elles soient rendues publiques conformément à l’article 75. |  |  |  |  |  |  |
...
**Tableau «Plan national d'allocation de quotas» pour la période 2008-2012**

| No de la ligne | Nom | Allocation de quotas du chapitre III | Entrée («L» signifie «Ligne») |  |  |
| --- | --- | --- | --- | --- | --- |
...
**Tableau «Allocation de quotas “aviation” à l'échelle de l'Union» pour la période 2008-2012**

| No de la ligne | Nom | Allocation de quotas du chapitre II | Entrée («L» signifie «Ligne») |  |  |
| --- | --- | --- | --- | --- | --- |
...
f) un symbole et une déclaration indiquant si l'installation ou l'exploitant d'aéronef lié au compte de dépôt d'exploitant a restitué, au 30 avril, un nombre d'unités de Kyoto ou de quotas au moins égal à l'ensemble de ses émissions pour toutes les années précédentes. Les symboles et les déclarations à publier sont indiqués dans le tableau XIII-I. Le symbole est mis à jour le 1er mai et, hormis l'ajout d'un astérisque * dans les cases décrites sur la ligne 5 du tableau XIII-I, il n'est pas modifié avant le 1er mai de l'année suivante.

*Tableau XIII-I: Déclarations de conformité*

| No ligne | Solde indicatif de l'état de conformité conformément à l'article 31 | Émissions vérifiées consignées pour l'année précédente complète? | Symbole | Déclaration |
| --- | --- | --- | --- | --- |
| à publier sur le site web public de l'EUTL |  |  |  |  |
| 1 | 0 ou tout nombre positif | Oui | A | «Le nombre de quotas et d’URE/URCE restitués au 30 avril est supérieur ou égal aux émissions vérifiées.» |
| 2 | Tout nombre négatif | Oui | B | «Le nombre de quotas et d’URE/URCE restitués au 30 avril est inférieur aux émissions vérifiées.» |
...
c) tout tableau des réserves établi conformément à la décision 2006/780/CE de la Commission (16);
...
e) la date et l'heure à laquelle la transaction a été achevée (heure de l'Europe centrale);
