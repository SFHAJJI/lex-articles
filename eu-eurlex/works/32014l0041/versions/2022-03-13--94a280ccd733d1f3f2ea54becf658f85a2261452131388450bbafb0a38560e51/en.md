...
valid_to: 'open'
source: 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02014L0041-20220313'
source_sha256: 'ae503582ec27e11dc4af68321331fca8b6327398d7deebb7b3fa6cf753930478'
...
(a) ‘issuing State’ means the Member State in which the EIO is issued;

(b) ‘executing State’ means the Member State executing the EIO, in which the investigative measure is to be carried out;
...
**4.** The issuing authority may transmit EIOs via the telecommunications system of the European Judicial Network (EJN), as set up by Council Joint Action. 98/428/JHA (3).
...
## CHAPTER V — INTERCEPTION OF TELECOMMUNICATIONS
...
## CHAPTER VI — PROVISIONAL MEASURES
...
**4.** The Commission shall make the information received under this Article available to all the Member States and to the EJN. The EJN shall make the information available on the website referred to in Article 9 of the Council Decision 2008/976/JHA (4).
