---
lex_id: 'eu-eurlex:32017r0587:2019-04-09'
...
valid_to: '2023-06-04'
source: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:02017R0587-20190409'
source_sha256: 'e777a9d5bed7dd80a5c5e3e75bcedb0991aee4d43c3f7da6b223d66956e97348'
...
a) lorsque deux membres ou participants de cette plate-forme de négociation participent à la transaction à l'un des titres suivants:

i) l'un négocie pour compte propre, alors que l'autre agit pour le compte d'un client;

ii) tous deux négocient pour compte propre;

iii) tous deux agissent pour le compte d'un client.

b) lorsqu'un membre ou participant de cette plate-forme de négociation:

i) agit à la fois pour le compte de l'acheteur et pour celui du vendeur; ou

ii) négocie pour compte propre en vue d'exécuter l'ordre d'un client.
