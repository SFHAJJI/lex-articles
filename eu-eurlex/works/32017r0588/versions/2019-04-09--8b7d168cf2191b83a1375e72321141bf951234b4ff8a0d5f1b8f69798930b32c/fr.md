---
lex_id: 'eu-eurlex:32017r0588:2019-04-09--8b7d168cf2191b83a1375e72321141bf951234b4ff8a0d5f1b8f69798930b32c'
...
valid_to: '2023-06-04'
source: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:02017R0588-20190409'
source_sha256: '1995b8516d9b87eafc58321639ff8bb4b1cdb647cb891de84b05e1caf21414b0'
...
a) la plate-forme de négociation présentant le volume d'échanges le plus élevé pour cette action est située dans un pays tiers;

b) lorsque ce nombre quotidien moyen de transactions a été calculé et publié conformément à la procédure décrite aux paragraphes 1 à 4, il est supérieur ou égal à un.
...
a) au plus tard quatre semaines avant la date d'entrée en application du règlement (UE) no 600/2014, lorsque l'action ou le certificat représentatif est négocié pour la première fois sur une plateforme de négociation dans l'Union dix semaines ou plus avant la date d'entrée en application du règlement (UE) no 600/2014;

b) au plus tard à la date d'entrée en application du règlement (UE) no 600/2014, lorsque les instruments financiers sont négociés pour la première fois sur une plateforme de négociation dans l'Union au plus tôt dix semaines et au plus tard un jour avant la date d'entrée en application du règlement (UE) no 600/2014;
