---
lex_id: 'eu-eurlex:32018r0389:2017-11-27'
...
valid_to: '2023-07-24'
source: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:32018R0389'
source_sha256: 'c2901dad4589448dd6afe9bc447b482f45f5362c6b023fa986da9a36b5d37091'
...
| a) | prennent les mesures nécessaires pour garantir qu'ils n'accèdent pas à des données ou qu'ils ne conservent ou ne traitent pas de données à des fins autres que la prestation du service demandé par l'utilisateur de services de paiement; |
| --- | --- |
...
| a) | le rôle du prestataire de services de paiement, qui peut consister en une ou plusieurs des fonctions suivantes:i)la gestion de comptes;ii)l'initiation de paiements;iii)l'information sur les comptes;iv)l'émission d'instruments de paiement liés à une carte; |
| --- | --- |
...
| a) | l'utilisateur ou les utilisateurs de services de paiement et la session de communication correspondante, afin d'opérer une distinction entre plusieurs demandes émanant du ou des mêmes utilisateurs de services de paiement; |
| --- | --- |
