---
lex_id: 'eu-eurlex:32022r1925:2022-09-14'
title: 'Regulation (EU) 2022/1925'
valid_from: '2022-09-14'
valid_to: '2022-10-11'
source: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:32022R1925'
source_sha256: '09a13a47d435808529c84c8c22b0032d120da3e2778fe953bf437852ffa39a5d'
...
| a) | à la suite de l’établissement de la liste figurant dans la décision de désignation conformément à l’article 3, paragraphe 9:i)messagerie textuelle de bout en bout entre deux utilisateurs finaux individuels;ii)partage d’images, de messages vocaux, de vidéos et d’autres fichiers joints dans les communications de bout en bout entre deux utilisateurs finaux individuels; |
| --- | --- |
...
| b) | dans un délai de deux ans à compter de la désignation:i)messagerie textuelle de bout en bout entre des groupes d’utilisateurs finaux individuels;ii)partage d’images, de messages vocaux, de vidéos et d’autres fichiers joints dans les communications de bout en bout entre une conversation de groupe et un utilisateur final individuel; |
| --- | --- |
...
| c) | dans un délai de quatre ans à compter de la désignation:i)appels vocaux de bout en bout entre deux utilisateurs finaux individuels;ii)appels vidéo de bout en bout entre deux utilisateurs finaux individuels;iii)appels vocaux de bout en bout entre une conversation de groupe et un utilisateur final individuel;iv)appels vidéo de bout en bout entre une conversation de groupe et un utilisateur final individuel. |
| --- | --- |
...
| b) | que le présent règlement ne permet pas de remédier de manière effective à une ou plusieurs pratiques et que ces pratiques sont susceptibles de limiter la contestabilité des service de plateforme essentiels ou d’être inéquitables. |
| --- | --- |
