---
lex_id: 'eu-eurlex:32024r1774:2024-06-25--7976c10f47484571b4f5427be672c24c35bf30ff004eb69564dbb0fa9534d85d'
...
valid_to: 'open'
source: 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02024R1774-20240625'
source_sha256: 'f012499213f75ce7ded7d020357417adfc7db8af8e1f2a354cc8a89c78cb5f41'
...
(m) for network services agreements: (i) the identification and specification of ICT and information security measures, service levels, and management requirements of all network services; (ii) whether those services are provided by an ICT intra-group service provider or by ICT third-party service providers.
...
**5.** The procedure referred to in paragraph 2 shall provide that:(a) non-production environments only store anonymised, pseudonymised, or randomised production data;(b) financial entities are to protect the integrity and confidentiality of data in non-production environments.
...
(b) establish a list of relevant contacts with internal functions and external stakeholders that are directly involved in ICT operations security, including on: (i) the detection and monitoring of cyber threats; (ii) the detection of anomalous activities; (iii) vulnerability management;
...
(d) retain all evidence relating to ICT-related incidents for a period that shall be no longer than necessary for the purposes for which the data are collected, commensurate with the criticality of the affected business functions, supporting processes, and ICT and information assets, in accordance with Article 8(2) of Commission Delegated Regulation (EU) 2024/1772 (2) and with any applicable retention requirement pursuant to Union law;
