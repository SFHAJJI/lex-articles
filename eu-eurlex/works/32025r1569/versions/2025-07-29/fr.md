---
lex_id: 'eu-eurlex:32025r1569:2025-07-29'
title: 'Commission Implementing Regulation (EU) 2025/1569 of 29 July 2025 laying down rules for the application of Regulation (EU) No 910/2014'
valid_from: '2025-07-29'
valid_to: 'open'
source: 'https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:32025R1569'
source_sha256: 'ab02f4674da4b0459e38f8658331036592c0ed765f5283aa25bef372e2f98395'
...
| a) | à la demande explicite de la personne à laquelle l’attestation électronique d’attributs a été délivrée ou, le cas échéant, de la personne à laquelle l’attestation se rapporte; |
| --- | --- |

| b) | lorsque le fournisseur sait que la sécurité ou la fiabilité des attestations électroniques d’attributs qualifiées ou des attestations électroniques d’attributs délivrées par un organisme du secteur public responsable d’une source authentique ou pour son compte a été compromise; |
| --- | --- |

| c) | dans d’autres situations, couvertes par le droit de l’Union ou le droit national, ou définies par les fournisseurs dans leurs règles visées au paragraphe 1. |
| --- | --- |
...
1. Les États membres transmettent au moins les informations mentionnées à l’annexe III concernant les organismes du secteur public visés à l’article 45 septies, paragraphe 3, du règlement (UE) no 910/2014 au moyen d’un système de notification électronique sécurisé fourni par la Commission.
...
| a) | sous une forme portant une signature électronique ou un cachet électronique adaptée au traitement automatisé et sur un site web lisible par l’être humain; |
| --- | --- |

| b) | sans qu’il soit nécessaire de s’inscrire ou de s’authentifier; |
| --- | --- |

| c) | en utilisant uniquement le protocole «sécurité de la couche de transport» le plus récent. |
| --- | --- |

3. La Commission publie, par l’intermédiaire d’un canal sécurisé et sans retard injustifié:

| a) | les spécifications techniques de la liste; |
| --- | --- |

| b) | l’adresse URL à laquelle la liste est publiée; |
| --- | --- |

| c) | les certificats à utiliser pour vérifier la signature électronique ou le cachet électronique apposé(e) sur la liste; |
| --- | --- |

| d) | les informations relatives aux mécanismes utilisés pour valider les modifications apportées ultérieurement à l’adresse ou aux certificats mentionnés aux points b) et c). |
| --- | --- |
...
3. Les États membres demandent que des attributs énumérés à l’annexe VI du règlement (UE) no 910/2014 soient inclus dans le catalogue d’attributs lorsque la vérification de ces attributs par des prestataires de services de confiance qualifiés repose sur des sources authentiques.
...
| a) | l’identification de l’entité à l’origine de la demande; |
| --- | --- |

| b) | le cas échéant, une référence à la disposition du droit de l’Union, du droit national ou à la pratique administrative en vertu de laquelle l’entité à l’origine de la demande est considérée comme étant une source première d’informations ou reconnue comme une source authentique; |
| --- | --- |

| c) | si la demande porte sur un attribut déjà enregistré dans le catalogue ou sur un nouvel attribut; |
| --- | --- |

| d) | un espace de noms pour l’identifiant des attributs, dont la valeur est unique au sein du catalogue d’attributs; |
| --- | --- |

| e) | l’identifiant de l’attribut, unique au sein de l’espace de noms, et la version de l’attribut; |
| --- | --- |

| f) | une description sémantique de l’attribut; |
| --- | --- |

| g) | le type de données de l’attribut; |
| --- | --- |

| h) | le point de vérification de l’attribut au niveau national ou un lien renvoyant vers une description des modalités d’ouverture des demandes de vérification. |
| --- | --- |
...
| a) | le nom du programme, choisi par le propriétaire du programme d’attestation d’attributs et unique au sein du catalogue de programmes d’attestation d’attributs; |
| --- | --- |

| b) | le nom et les coordonnées du propriétaire du programme d’attestation d’attributs; |
| --- | --- |

| c) | le statut et la version du programme; |
| --- | --- |

| d) | une référence aux lois, normes ou lignes directrices spécifiques desquelles dépendent la délivrance, la validation ou l’utilisation d’une attestation électronique d’attributs couverte par le programme; |
| --- | --- |

| e) | le ou les formats de l’attestation électronique d’attributs couverte par le programme; |
| --- | --- |

| f) | un ou plusieurs espaces de noms, identifiants d’attributs, descriptions sémantiques et types de données pour chaque attribut faisant partie d’une attestation électronique d’attributs couverte par le programme, soit par référence à un attribut figurant dans le catalogue d’attributs visé à l’article 7, soit par référence à un attribut défini de manière similaire dans le cadre du programme; |
| --- | --- |

| g) | une description du modèle de confiance et des mécanismes de gouvernance appliqués dans le cadre du programme, y compris des mécanismes de révocation; |
| --- | --- |

| h) | toute exigence concernant les fournisseurs d’attestations électroniques d’attributs ou les sources d’information sur lesquelles ces fournisseurs s’appuient lorsqu’ils délivrent des attestations électroniques d’attributs, y compris toute source authentique, le cas échéant; |
| --- | --- |

| i) | une déclaration indiquant si les attestations électroniques d’attributs couvertes par le programme doivent être délivrées sous la forme d’attestations électroniques d’attributs qualifiées, d’attestations électroniques d’attributs délivrées par un organisme du secteur public responsable d’une source authentique ou pour son compte, ou les deux. |
| --- | --- |
