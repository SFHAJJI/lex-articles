---
lex_id: 'lu-legilux:loi-1973-07-28-n1:2022-01-17--4f05c71a1a709b9d2254b32905e942ecbfd1f0983ca73e045d7e022c7f493c7b'
title: 'Version consolidée applicable au 17/01/2022 : Loi du 28 juillet 1973 portant création d''un service de la navigation.'
valid_from: '2022-01-17'
valid_to: 'open'
source: 'https://legilux.public.lu/eli/etat/leg/loi/1973/07/28/n1/consolide/20220117/fr'
source_sha256: 'a70449a7df3119dbeeef536de3cf882ea2fe1beba939fd0d36a5ab40d9acc4fe'
license: 'CC-BY-4.0'
...
1. 1. Identifiant utilisateur (Maritime Mobile Service Identity, MMSI) ;
2. Nom du bateau ;
3. Type de bâtiment ou de convoi conformément au standard suivi et repérage des bateaux en navigation intérieure ;
4. Numéro européen unique d’identification des bateaux (ENI) ou, pour les navires de mer auxquels n’a pas été attribué d’ENI, le numéro OMI ;
5. Longueur hors tout du bâtiment ou du convoi avec une précision de 0,1 m ;
6. Largeur hors tout du bâtiment ou du convoi avec une précision de 0,1 m ;
7. Position (WGS 84) ;
8. Vitesse sur route ;
9. Route ;
10. Heure de l’appareil électronique de localisation ;
11. Statut navigationnel conformément à l’annexe 11 du règlement de police pour la navigation de la Moselle ;
12. Point d’acquisition de l’information relative à la position à bord du bâtiment avec une précision de 1 m, conformément à l’annexe 11 du règlement de police pour la navigation de la Moselle.
2. 1. Prénom et nom
2. Adresse.
...
**3.** Tant qu’un des emplois prévus à l’article 4 est occupé par un employé ou un artisan, il ne peut être occupé par un fonctionnaire.
