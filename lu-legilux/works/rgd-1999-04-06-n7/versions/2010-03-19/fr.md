...
## Chapitre 4 — Mise en œuvre des objectifs du parc naturel
...
***Liste des communes concernées par le Parc Naturel de la Haute-Sûre****** (cf. art. 3 du règlement)***
...
|  | B: Baschleiden |
|  | C: Surré |
| Esch-sur-Sûre | A: Esch-sur-Sûre |
| Heiderscheid | A: Tadler |
|  | B: Ringel |
|  | C: Heiderscheid |
|  | D: Eschdorf |
|  | E: Merscheid |
| Lac de la Haute-Sûre | HA: Tarchamps |
|  | HB: Watrange |
|  | HC: Harlange (a.c.) |
|  | MA: Kaundorf |
|  | MB: Nothomb |
...
|  | MD: Liefrange |
|  | ME: Bavigne |
| Neunhausen | A: Lultzhausen |
|  | B: Neunhausen |
|  | C: Insenborn |
| Winseler | A: Grumelscheid |
|  | B: Noertrange |
|  | C: Winseler |
|  | D: Berlé |
|  | E: Doncols-Sonlez |
