---
lex_id: 'lu-legilux:rgd-2007-07-24-n1:2014-09-15--85e48e2806b07c46675203558579c712b486fd7a5239545ff4ace95927660aca'
...
valid_to: '2015-09-14'
source: 'https://legilux.public.lu/eli/etat/leg/rgd/2007/07/24/n1/consolide/20140915/fr'
source_sha256: '460f5a0cfeea2e8d8e8fb9c521f67cc2d12bbca96f1d60dd127b014ca6446851'
license: 'CC-BY-4.0'
...
1. e e e e e e | Coefficients | Nombre d’élèves |  |  |
| --- | --- | --- | --- |
| Classes | < 11 | 11-17 | > 17 |
| tous niveaux | 0,90 | 0,95 | 1 |

1. 1. | Coefficients | Nombre d’élèves |  |  |
| --- | --- | --- | --- |
| Classes | < 5 | 5-9 | > 9 |
|  | 0,9 | 0,95 | 1 |
...
| Classes | < 8 | 8 ou > 8 |
|  | 0,95 | 1 |
3. | Coefficients | Nombre d’élèves |  |  |  |
| --- | --- | --- | --- | --- |
| Classes | < 5 | 5-7 | 8-11 | > 11 |
|  | 0,9 | 0,95 | 1 | 1,08 |

1. | Classes | Coefficient | facteur 1 | facteur 2 | facteur 3 |
| --- | --- | --- | --- | --- |
| 10e AS | 1,30 | * 0,150 | *n leçons grille | * n élèves |
| 11e AS | 1,30 | * 0,150 | *n leçons grille | * n élèves |
| 12e AS | 1,30 | * 0,150 | *n leçons grille | * n élèves |
| 12e SI | 1,30 | * 0,046 | *n leçons grille | * n élèves |
| 13e SI | 1,30 | * 0,046 | *n leçons grille | * n élèves |
| 14e SI | 1,30 | * 0,050 | *n leçons grille | * n élèves |
| BTS SI (1er et 2e semestre) | 1,30 | * 0,044 | *n leçons grille | * n élèves |
| BTS SI (3e et 4e semestre) | 1,30 | * 0,038 | *n leçons grille | * n élèves |
| BTS spécialisé | 1,30 | * 0,035 | *n leçons grille | * n élèves |
| 12e ED | 1,30 | * 0,017 | *n leçons grille | * n élèves |
| 13e ED | 1,30 | * 0,014 | *n leçons grille | * n élèves |
| 14e ED | 1,30 | * 0,018 | *n leçons grille | * n élèves |
2. | Classes | Coefficient | facteur 1 | facteur 2 | facteur 3 |
| --- | --- | --- | --- | --- |
| 13e SH | 1,30 | *0,0256 | *5 leçons grille | *n élèves |
| 12e ED | 1,30 | *0,0416 | *2 leçons grille | *n élèves |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Classes | < 09 | 9-10 | 11-15 | 16-17 | 18-25 | 26-27 | > 27 |
...
| 1ère ES13e EST (fin d’études)14e EST (prof. santé/sociales) | 1,10 | 1,10 | 1,15 | 1,23 | 1,30 | 1,37 | 1,45 |
...
| **CODIS** | décharge accordée aux coordinateurs de disciplines intervenant dans le stage pédagogique. |
...
| **GESLA** | décharge accordée pour gestion d’un laboratoire ou d’installations servant à l’enseignement théorique et/ou pratique. |
...
| **SPORT** | décharge accordée pour assurer des activités sportives en dehors des heures de cours. |
| **SURV** | décharge accordée pour assurer des leçons de surveillance. |
| **TUTEU** | décharge accordée aux tuteurs de stagiaires intervenant dans le stage pédagogique. |
