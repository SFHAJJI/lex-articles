---
lex_id: 'lu-legilux:rgd-2022-05-23-a281:2022-10-23--25675738c4b3a04085b89a3f08672d5157cec2024f3e66bad0efe123ab3309a9'
title: 'Version consolidée applicable au 23/10/2022 : Règlement grand-ducal du 23 mai 2022 concernant la réglementation de la circulation sur la grande voirie et les aires de service.'
valid_from: '2022-10-23'
valid_to: 'open'
source: 'https://legilux.public.lu/eli/etat/leg/rgd/2022/05/23/a281/consolide/20221023/fr'
source_sha256: '5144a9363d6d4bb52b7d61e1559c14697bfe8a84470547583b338aafa399a989'
license: 'CC-BY-4.0'
...
*conducteur *: tout conducteur d’un véhicule admis à circuler sur les autoroutes et les routes pour véhicules automoteurs conformément aux articles 156 et 156*ter* de l’arrêté grand-ducal précité du 23 novembre 1955, à moins qu’il n’en soit spécifié autrement ;
...
1. Cette disposition est indiquée par le signal D,1a portant l’indication de la ou les directions à suivre.
2. Cette disposition est indiquée par le signal D,1a portant l’indication de la ou les directions à suivre et complété par un panneau additionnel du modèle 1 portant le symbole du véhicule automoteur destiné au transport de choses avec l’inscription de « 3,5t » sur la silhouette du véhicule.
3. arrêté grand-ducal modifié précité du 23 novembre 1955 Cette disposition est indiquée par le signal B,1.
4. - en présence d’un îlot médian séparant la bretelle d’accès de la bretelle de sortie, les conducteurs doivent, le cas échéant, contourner celui-ci conformément au signal en place ;
...
- lorsque deux bretelles d’accès se rejoignent en amont de la chaussée de l’autoroute, les conducteurs qui circulent sur ces bretelles doivent suivre les directions indiquées par les signaux en place. Ces dispositions sont indiquées respectivement par les signaux D,2, E,11a, B,1 et D,1a portant l’indication de la ou les directions à suivre.
5. arrêté grand-ducal modifié précité - sur l’autoroute A6, échangeur Windhof, en direction de Luxembourg-ville ;
...
6. - à l’intersection avec la voirie normale, les conducteurs qui circulent sur la bretelle doivent céder le passage aux conducteurs de véhicules et d’animaux qui circulent dans les deux sens sur la voirie normale et, le cas échéant, lorsque les conditions de visibilité sont réduites, marquer l’arrêt et céder le passage à ces derniers ;
- un passage pour piétons est aménagé, le cas échéant, à l’intersection avec la voirie normale ;
- l’accès à la bretelle est interdit aux conducteurs à partir de la voirie normale ou, le cas échéant, à partir de la zone d’approche d’une aire de service en direction de la chaussée de l’autoroute. Ces dispositions sont indiquées respectivement par les signaux B,1, B,2a, E,11a et C,1a.
7. - à 70 km/h sur les voies de décélération menant vers les aires de service et, le cas échéant, sur les bretelles de sortie menant vers les aires de service ;
...
- aux vitesses telles que reprises à l’annexe 3, qui fait partie intégrante du présent règlement, aux endroits y indiqués. Ces dispositions sont indiquées par le signal C,14 portant le chiffre de la vitesse maximale limitée.
8. Cette interdiction est indiquée par le signal C,13aa.
...
1. - à 50 km/h dans la zone d’approche et la voirie d’accès par la voirie normale ;
- à 30 km/h sur les voiries publiques à l’exception de la voirie d’accès par la voirie normale et dans les zones autres que la zone d’approche. Ces dispositions sont indiquées par le signal C,14 portant le chiffre de la vitesse maximale limitée.
2. Cette interdiction est indiquée par le signal C,1a.
3. Cette disposition est indiquée par le signal D,1a portant l’indication de la ou les directions à suivre.
4. Cette interdiction est indiquée par le signal C,4a portant les symboles des catégories de véhicules concernées, complété par un panneau additionnel du modèle 5a portant l’inscription « excepté fournisseurs ».
5. Cette interdiction est indiquée par le signal C,3a, complété par un panneau additionnel du modèle 1 portant le symbole du véhicule automoteur suivi de l’inscription « ≤ 3,5t » et par un panneau additionnel du modèle 5a portant l’inscription « excepté fournisseurs ».
6. - les sorties des parkings à hauteur du croisement avec les voies pour autocars et camions, les voies mixtes et les voies pour voitures ;
...
- les voies camions de la branche droite, dans le sens de la circulation, lorsque deux branches de voies camions se rejoignent, à hauteur du croisement avec les voies camions de la branche gauche. Cette disposition est indiquée sur les voies non prioritaires par le signal B,1.
7. - les voies pour voitures à hauteur du croisement avec les zones d’approvisionnement voitures et caravanes ;
- les voies mixtes à hauteur du croisement avec les zones d’approvisionnement voitures et caravanes. Cette disposition est indiquée sur les voies non prioritaires par le signal B,2a.
8. - les voies camions à hauteur du croisement avec les zones d’approvisionnement pour autocars et pour camions. Cette disposition est indiquée sur les voies non prioritaires par le signal B,1.
9. - Cette disposition est indiquée par le signal D,3 ;
- Cette disposition est indiquée par le signal B,2a.
10. arrêté grand-ducal modifié précité
11. Cette disposition est indiquée par le signal E,23 complété par un panneau additionnel adapté.
12. Cette disposition est indiquée par le signal E,23 complété par un panneau additionnel adapté.
13. Cette disposition est indiquée par le signal E,23 complété par un panneau additionnel adapté.
14. Cette disposition est indiquée par le signal C,19.
15. Cette disposition est indiquée par le signal C,18.
...
Le règlement grand-ducal modifié du 31 octobre 2008 concernant la réglementation de la circulation sur la grande voirie et les aires de service et le règlement grand-ducal du 5 février 2010 concernant la réglementation de la circulation sur la grande voirie et les aires de service sont abrogés.
...
| A7 - Bretelle F2-N | Échangeur Lorentzweiler - Bretelle d’accès en direction de la jonction Grünewald | A7F2-N PR 0,00+060 -A7F2-N PR 0,00+620 |
